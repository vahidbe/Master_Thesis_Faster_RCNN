...
if __name__ == "__main__":
    ...
    train_path = './sub_data/data_annotations.txt'  # Training data (annotation file)
    data_path = './sub_data'
    ...
    output_weight_path = os.path.join(base_path, 'model/tmp.hdf5')

    record_path = os.path.join(base_path,
                               'model/tmp.csv')  # Record data (used to save the losses, classification accuracy and mean average precision)

    base_weight_path = os.path.join(base_path, 'model/vgg16_weights_tf_dim_ordering_tf_kernels.h5')

    config_output_filename = os.path.join(base_path, 'tmp.pickle')
