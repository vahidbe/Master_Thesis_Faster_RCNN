...
if __name__ == "__main__":
    ...
    test_path = './sub_data/data_annotations.txt'  # Test data (annotation file)
    data_test_path = './sub_data'

    test_base_path = './sub_data'  # Directory to save the test images
    ...
    C.model_path = os.path.join(base_path, 'model/tmp.hdf5') #UPDATE WEIGHTS PATH HERE !!!!!!!!
