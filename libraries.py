...
class BoxFilter:
    def __init__(self, ksize, normalize):
        self.ksize = ksize
        self.normalize = normalize
        self.name = "box_filter"

    def __str__(self):
        return "box_filter-ksize={}-normalize={}".format(self.ksize, self.normalize)


class EqualizeHist:
    def __init__(self):
        self.name = "equalize_hist"
...
class Config:
    def __init__(self):
        ...
        self.brightness_jitter_bound = 0.5
        ...
        # pre-processing method (None if nothing else than basic operations)
...
def augment(img_data, config, augment=True):
    ...
    if augment:
        ...
        if config.use_brightness_jitter:
            alpha = 1.0 + random.uniform(-config.brightness_jitter_bound, config.brightness_jitter_bound)
...
'''
    Functions related to training part
'''
...
def format_img(img, C):
    """ formats and pre-process an image for model prediction based on config """
